...
interface UserInfo { id: number; token_balance: number; status: string; hermes_user_id: string | null; created_at: string; }
        ...
        <div className="bg-slate-900/60 border border-white/10 rounded-2xl p-6 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              {user?.hermes_user_id ? <p className="text-emerald-400">已绑定</p> : <p className="text-amber-400">未绑定 <Link href="/bind" className="text-xs text-amber-300 underline">前往绑定</Link></p>}
            </div>
